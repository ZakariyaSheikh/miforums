                    ...
                    <div className='container'>
                        <div className='row no-gutters center-content'>
                            <div className='col-lg-9 mr-lg-auto py-3'>
                                <br />
                                <p>
                                Joining us at m&i Private Europe in Budapest? On this webpage, we’ll be covering everything you need to know about COVID-19 at this Forum and our procedures in the event of any positive cases.
                            ...
                            <div className='col-lg-9 mr-lg-auto py-3'>
                                ...
                                <p>
                                    <li>Please ensure you take a Covid test no more than 72 hours before the event. </li>
                                    <li>Email proof of your negative result to    <a
                                        class='blue'
                                        href='mailto:eventsupport@wwideevents.com'
                                    >
                                       eventsupport@wwideevents.com.
                                    </a>{' '}</li>
                                    ...
                                    <li>Remember to pack your face mask, as we recommend wearing one whilst indoors. Although face coverings are not a legal requirement in Hungary, wearing one can reduce the risk of infection for both yourself and others. We believe this is the best course of action to ensure a smooth-running event for all.</li>
                            ...
                            <div className='col-lg-9 mr-lg-auto py-3'>
                                ...
                                <p>
                                    <li>If you feel unwell or show symptoms for COVID-19 during travel or at the airport, our team will direct you to the airport’s testing facilities. Following the test, you will be given a private transfer to the hotel, where you will be required to self-isolate until a negative test result is provided.
                                    </li>
                                    ...
                                    <li>There will be a dedicated first aid and testing service available at the hotel. We advise you to contact your travel insurance company for any unforeseen costs.</li>
                            ...
                            <div className='col-lg-9 mr-lg-auto py-3'>
                                <h3> What to do if my travel and accommodation are affected in the event of a positive COVID-19 test result or exposure to COVID-19?</h3>
                                <p>
                            ...
                            <div className='col-lg-9 mr-lg-auto py-3'>
                                ...
                                <p>
                                    ...
                                    >
                                       eventsupport@wwideevents.com.
                                    </a>{' '} or sending us a Whatsapp message on <a  class='blue' href="tel:07545734284">+44 (0) 7545734284 </a>
                                </p>
                            </div>
...
export default CovidProcedures;
