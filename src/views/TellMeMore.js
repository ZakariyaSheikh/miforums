...
import Shape from '../assets/images/Tellmemore_image.png';
        ...
        <div className="row">
                ...
                <div className="column rightSide">
                            ...
                            <div className='container' >
                                ...
                                <form
                            action='https://www2.wwideevents.com/l/852593/2022-06-14/fdsvw'
                            method='post'
                            id='sectionForm'>
                            <div className='form'>
                                <div className='container' >
                                            ...
                                            <div className='col signupform'>
                                                ...
                                                <input
                                                    ...
                                                    required
                                                        ...
                                                        <br />
                                                        <select className="events" name="contact_form">
                                                            <option name="contact_form" value="Give me a call" >give me a call</option>
                                                            <option name="contact_form" value="Send me a brochure">send me a brochure</option>
                                                            <option name="contact_form" value="Other">other - answer my question below</option>
                                                        </select>
                                                        <textarea  name="Contact_us_Form_Text"
                    type="text"
                    maxLength="10000" rows='12' cols='50'></textarea>
