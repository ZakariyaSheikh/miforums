...
import Thumbnail2 from "../assets/images/ambassador/Ambassador_email_signature.png"
...
const Ambassador = () => {
  ...
  return (
    <>
      ...
      <div className="site-wrap" style={{backgroundColor:'#121A36'}}>
        <div
          className="ambassador-hero-slider"
            ...
            <div className="row no-gutters align-items-stretch">
              <div className="col-lg-12 ml-rg-auto py-5">
                ...
                welcome to the
                  <br />
                 {" "} m&i Ambassador<br />  {" "}
                  club, <span className="yellow-underlined">you legend!</span>
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row no-gutters">
              <div className="col-lg-8 mr-lg-auto py-5 ambassador-caption" >
                <p>
                We’re thrilled that you’ve chosen to become an m&i Ambassador, a title reserved only for a select few industry influencers like you. Here are your exclusive ambassador assets. Simply download to use on your social channels and emails.
                </p>
              </div>
            </div>
          </div>
 ...
 share this one on your social media story
                  ...
                  <p><a href="/images/ambassador/mi_Ambassador_social_story.png" download><span className="coral-underlined">Download</span></a> story image</p></div>
 ...
 add this one to your email signature
                  ...
                  <p><a href="/images/ambassador/mi_Ambassador_signature.gif" download><span className="coral-underlined">Download</span></a>  signature</p></div>
